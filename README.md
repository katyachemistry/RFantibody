...
See "fixed" branch. This is a repo with fixes which helped to successfully run examples in docker. Some scripts and directories were copied, so you may find duplicate files in different directories.
